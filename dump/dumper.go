...
func (d *Dumper) printCaller(pc uintptr, file string, line int) {
	// eg: github.com/reaperhero/instrument/dump.ExamplePrint
	...
	// eg:
	// "PRINT AT github.com/reaperhero/instrument/dump.ExamplePrint(goutil/dump/dump_test.go:23)"
	// "PRINT AT github.com/reaperhero/instrument/dump.ExamplePrint(dump_test.go:23)"
	// "PRINT AT github.com/reaperhero/instrument/dump.ExamplePrint(:23)"
